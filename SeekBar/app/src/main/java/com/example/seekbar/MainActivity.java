...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seekBarEscala.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStartTrackingTouch(SeekBar seekBar) {
                textResultado.setText(" Pressione e arraste para definir um progresso. ");
            }

            @Override
            public void onStopTrackingTouch(SeekBar seekBar) {
                textResultado.setText(" Progresso escolhido, recupere-o clicando no botão acima. ");
            }
        });
    ...
    public void recuperarProgresso(View view){
        ...
        textResultado.setText(" Progresso escolhido:  " + seekBarEscala.getProgress());
